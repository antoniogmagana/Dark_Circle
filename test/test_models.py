...
from models import ClassificationCNN, DetectionCNN
...
class TestDetectionCNN:
    ...
    def test_model_initialization(self, mock_config):
        ...
        model = DetectionCNN(in_channels=mock_config.IN_CHANNELS, num_classes=2, config=mock_config)
...
class TestClassificationCNN:
    ...
    def test_model_initialization(self, mock_config):
        ...
        model = ClassificationCNN(
            in_channels=mock_config.IN_CHANNELS, num_classes=3, config=mock_config
        )
...
class TestModelComparison:
    ...
    def test_detection_smaller_than_classification(self, mock_config):
        ...
        detection = DetectionCNN(
            in_channels=mock_config.IN_CHANNELS, num_classes=2, config=mock_config
        )
