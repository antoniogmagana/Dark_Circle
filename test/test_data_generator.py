...
class TestGenerateNoVehicleSample:
    ...
    def test_sensor_hiss_profile(self, mock_config):
        ...
        sample = generate_no_vehicle_sample(mock_config, noise_profile="sensor_hiss")
    ...
    def test_environmental_profile(self, mock_config):
        ...
        sample = generate_no_vehicle_sample(mock_config, noise_profile="environmental")
    ...
    def test_custom_amplitude_scalar(self, mock_config):
        ...
        sample = generate_no_vehicle_sample(
            mock_config, amplitude=amplitude, noise_profile="sensor_hiss"
        )
    ...
    def test_environmental_smoother_than_hiss(self, mock_config):
        ...
        hiss = generate_no_vehicle_sample(mock_config, noise_profile="sensor_hiss", amplitude=0.01)

        env = generate_no_vehicle_sample(mock_config, noise_profile="environmental", amplitude=0.01)
...
class TestDataGeneratorIntegration:
    ...
    def test_noise_and_augmentation_pipeline(self, mock_config):
        ...
        samples = [
            generate_no_vehicle_sample(mock_config, noise_profile="environmental") for _ in range(8)
        ]
    ...
    def test_multiple_noise_profiles_compatible(self, mock_config):
        ...
        hiss = generate_no_vehicle_sample(mock_config, noise_profile="sensor_hiss")
        env = generate_no_vehicle_sample(mock_config, noise_profile="environmental")
